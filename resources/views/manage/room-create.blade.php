<x-admin-layout title="เพิ่มห้องประชุม">
    <x-slot name="AdminContent">
        <div class="flex justify-center mt-3">
            <form class="fieldset w-xs lg:w-lg" action="" method="POST" enctype="multipart/form-data">
                <fieldset class="fieldset shadow bg-base-100 border-base-300 rounded-box border p-4 w-full ">
                    ...
                    <input type="file" accept="image/*" name="roomPic"
                        class="file-input file-input-bordered file-input-primary w-full" placeholder="รูปภาพห้องประชุม" />
